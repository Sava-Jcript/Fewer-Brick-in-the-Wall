...
function timeRunning() {
    ...
    var timeLeft = 100;
    interval = setInterval(frame, 540);
...
function targetClick() {
    audio = new Audio("/Users/alimerkouk/Desktop/fewer/graphics/good-click.wav");
    audio.play();
...
function gameOver() {
    audio1 = new Audio("/Users/alimerkouk/Desktop/fewer/graphics/lose-sound.wav");
    audio1.play();
    audio2.pause();
    mySound.pause();
...
function winGame() {
    ...
    audio2 = new Audio('/Users/alimerkouk/Desktop/fewer/graphics/win-sound.wav');
    audio2.play();
    audio1.pause();
...
function loseGame() {
    ...
    document.querySelector(".home").addEventListener("click", exit);
    audio3 = new Audio('/Users/alimerkouk/Desktop/fewer/graphics/lose-sound.wav');
    audio3.play();
    audio1.pause();
